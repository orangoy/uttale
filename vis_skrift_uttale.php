...
function vis_skrift_uttale(){
	...
	$dt .= "</style>";
	$dt .= '<table id="skrift_uttale" class="display" style="width:100%"><thead></thead><tbody>';
	...
	$dt .= "var dataSet_skrift_uttale =" . json_encode($data, JSON_PRETTY_PRINT);
